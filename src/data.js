export const flipbookTexts = [
  // Indeks 0: Teks untuk Sampul Depan
  `i know i don’t always say how i feel but every little thing here is made with love, just for you,this is me, trying to show what words can’t i just hope when you see this you can feel how much i truly love you and i hope you’ll remember my heart has always been yours.`,

  // Indeks 1: Teks untuk gambar pertama (DIGABUNG)
  `i’m so proud of you for everything you’ve done and for the strength you carry so quietly you’ve come so far and i hope you know my heart is always with you.`,

  // Indeks 2: Teks untuk gambar kedua (DIGABUNG)
...
i’m so thankfu it’s you..`,

  // Indeks 3: Teks untuk gambar ketiga (DIGABUNG)
...
you’ve been one of the kindest parts of my story and i’m so lucky it’s you`,
  ...
  // Indeks 4: Teks untuk gambar keempat
  `hi my love
...
and that means more to me than you’l ever know `,

  // Indeks 7: Placeholder, GANTI DENGAN TEKS ANDA
  `i don’t know how long forever is,
but i know i’ll keep choosing you.
in every quiet way,
it’ll always be you.`,

  // Indeks 8: Placeholder, GANTI DENGAN TEKS ANDA
  `with you, i don’t have to hide parts of me
i feel safe, seen, and understood
you’re my calm in every chaos`,

  // Indeks 9: Placeholder, GANTI DENGAN TEKS ANDA
...
i just want us to keep understanding, and choosing each other, always.`,
  ...
  // Indeks 10: Placeholder, GANTI DENGAN TEKS ANDA
...
but as long as it’s with you, i know i’m right where i’m meant to be.`,
  ...
  // Indeks 11: Teks untuk Sampul Belakang
